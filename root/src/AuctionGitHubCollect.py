...
class GitHubCollector:
    ...
    def __init__(self) -> None:
        ...
        self.auct_path = os.path.join(self.data_path, "AuctionData")
        self.raw_path  = os.path.join(self.auct_path, "RawGitHubData")
        self.note_path = os.path.join(self.root_path, "notebooks")
        self.prep_path = os.path.join(self.auct_path, "CleanedGitHubData")
